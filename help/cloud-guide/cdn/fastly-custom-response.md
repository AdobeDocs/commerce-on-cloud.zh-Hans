...
- 内容最多可包含65,535个字符。
- 指定HTML源中的所有CSS内联。
- 在HTML页面中使用base64捆绑图像，以便即使Fastly处于离线状态也能显示这些图像。 查看css-tricks网站](https://css-tricks.com/data-uris/)上的[数据URI。
...
1. 填写字段以更新HTML。
   ...
   - **MIME类型** — 类型`text/html`。
   - **内容** — 编辑默认的HTML响应以添加自定义CSS，并根据需要更新标题和消息。
