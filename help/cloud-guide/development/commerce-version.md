...
您可以将Adobe Commerce代码库升级到较新版本。 在升级环境之前，请查看&#x200B;_安装_&#x200B;指南中的[系统要求](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html)以了解最新的软件版本要求。
