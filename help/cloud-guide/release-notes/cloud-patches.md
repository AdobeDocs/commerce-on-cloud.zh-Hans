...
- ![修复图标](../../assets/fix.svg) **修补程序** — 启用JS缩小和捆绑时，[签出失败](https://experienceleague.adobe.com/zh-hans/docs/experience-cloud-kcs/kbarticles/ka-27997))，如*Commerce知识库”(票证AC-15867和ACSD-68617)中所述。<!-- MCLOUD-14191 -->
