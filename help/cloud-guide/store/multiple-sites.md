...
若要将本地安装配置为使用多个商店，请参阅[配置指南](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/multi-sites/ms-overview.html?lang=zh-Hans)中的&#x200B;_多个网站或商店_。
