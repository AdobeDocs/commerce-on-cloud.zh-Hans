...
description: 了解如何保护对您的Adobe Commerce云基础架构项目的管理员访问权限，重置您的许可证所有者密码，以及登录到“管理员”面板。
...
>[!TIP]
>
>如果密码重置失败或您无法登录到“管理员”面板，则具有管理员访问权限的用户可以使用SSH连接到项目，并使用`admin:user:create` CLI命令添加管理员用户。 请参阅&#x200B;_安装指南_&#x200B;中的[创建、编辑或解锁管理员帐户](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/tutorials/admin)。
